let Post,mongoose,Joi,sanitizeHtml;_74f‍.x([["getPostById",()=>getPostById],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["addLike",()=>addLike],["cancleLike",()=>cancleLike],["path",()=>path],["giveComment",()=>giveComment],["deleteComment",()=>deleteComment],["likeby",()=>likeby],["cancleLikeby",()=>cancleLikeby],["editprofileurl",()=>editprofileurl],["editusername",()=>editusername]]);_74f‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_74f‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_74f‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_74f‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);
...
// fileurl 에 File의 path 넣어주기
       const path = async (ctx) => {
    const { id } = ctx.params;
    const {fileurl} = ctx.request.body;
    _74f‍.g.console.log(fileurl);
...
// 피드 글쓴이의 프로필 사진 변경
       const editprofileurl = async (ctx) => {
