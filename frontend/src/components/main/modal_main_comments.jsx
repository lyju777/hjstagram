...
function Modal_Main_Comments(props) {
    ...
    <img className="main_profileImage" src="img/pizza.jpg" alt=""/></div>
    ...
    return(
      <>    
        ...
        <div className="profile_div">{main_profileImage}{username}</div><div className="main_Point_div" onClick={props.closecomment}><img className="main_Point commment_close" src="img/close.png" alt=""
            /></div>
        </div>
